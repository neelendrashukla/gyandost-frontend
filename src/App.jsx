...
import MindMapExplorer from "./components/MindMapExplorer.jsx";
import SanskritiGyan from "./components/SanskritiGyan.jsx";
import GameZone from "./components/GameZone.jsx";
import GameLobby from "./components/GameLobby.jsx";
import CreativeCorner from "./components/CreativeCorner.jsx";
import AiKeAjoobe from "./components/AiKeAjoobe.jsx";
import AnimatedPage from "./components/AnimatedPage.jsx";
import ExamMode from "./components/ExamMode.jsx";
import PoemWeaver from "./components/PoemWeaver.jsx";
import ScriptWeaver from "./components/ScriptWeaver.jsx";
import StoryWeaver from "./components/StoryWeaver.jsx";
import { Howler } from 'howler';

export default function AppWrapper() {
  return <BrowserRouter><App /><Toaster position="top-center" reverseOrder={false} /></BrowserRouter>;
}

function App() {
  const [session, setSession] = useState(null);
  const [loadingInitial, setLoadingInitial] = useState(true);
  const { profile, updateProfile, loading: profileLoading } = useProfile(session?.user);
  ...
  if (loadingInitial || (session && profileLoading)) {
    return <div className="flex justify-center items-center h-screen bg-cosmic-blue text-white">Loading GyanDost...</div>;
  }
