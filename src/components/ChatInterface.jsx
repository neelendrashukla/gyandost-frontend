...
// Parse content into blocks and options
...
export default function ChatInterface({ messages, onOptionClick, onSendMessage, loading }) {
  ...
  const { isListening, transcript, handleListen } = useSpeechRecognition('hi-IN');
      ...
      <div className="flex-1 overflow-y-auto space-y-6">
        {messages.map((msg, index) => {
          ...
          return (
            ...
            >
              {/* Mascot for AI messages */}
              {msg.sender === 'ai' && (
                <div className="flex justify-center w-full md:w-auto">
                  <GyanDostMascot
                    state={currentMsgIsSpeaking ? 'talking' : 'idle'}
                    height="150px"
                    width="150px"
